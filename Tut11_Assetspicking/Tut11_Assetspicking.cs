...
namespace Fusee.Tutorial.Core
{
    public class Tut11_Assetspicking : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            _rightRearTransform = _scene.Children.FindNodes(node => node.Name == "backwheelright")?.FirstOrDefault()?.GetTransform();
        ...
        {
            _rightRearTransform.Rotation = new float3(M.MinAngle(TimeSinceStart),90,0);
